#!/usr/bin/env bash
# Run 013 — speechLLM B1 utterance, encodeur Pantagruel-L-114k (speech-large-114K).
...
#   mkdir -p logs
#   nohup bash 2_speechLLM/scripts/run_013_speechllm_b1_utterance_large_114k_nohup.sh \
#     > logs/run_013_wrapper.log 2>&1 &
#   echo $! > logs/run_013_nohup.pid
#   tail -f logs/run_013_speechllm_b1_utterance_large_114k_train_eval.log
...
CFG="2_speechLLM/configs/fr-en/b1_utterance_large_114k.yaml"
RUN="run_013_speechllm_b1_utterance_large_114k"
...
{
  echo "=== $(date -Is) RUN ${RUN} (Pantagruel-L-114k, train → evaluate) ==="
