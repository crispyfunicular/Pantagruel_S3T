#!/usr/bin/env bash
# Modyco — après run_035 : run_036 warmup 10k → run_039 speechLLM SpecAugment →
# run_040 Speech_Text utterance → run_037 SpecAugment fort.
#
# Usage (Modyco) :
...
wait_gpu_free
echo "=== $(date -Is) Lancement run_036 ST L-14k v9 warmup 10k ==="
bash "${ROOT}/scripts/run_modyco_st_14k_v9_warmup10k.sh"
...
echo "=== $(date -Is) Chaîne Modyco post-035 (036→039→040→037) terminée ==="
