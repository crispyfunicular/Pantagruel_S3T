...
RUN_WHISPER="run_075_modyco_open_whisper_st_utterance"
RUN_SEAMLESS="run_075b_modyco_open_seamlessm4t_v2_utterance"
LOG="logs/run_075_modyco_open_baselines_eval.log"
