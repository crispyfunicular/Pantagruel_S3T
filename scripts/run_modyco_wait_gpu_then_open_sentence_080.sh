...
#   tail -f logs/run_waiter_open_080_modyco.log
...
TARGET_SCRIPT="${ROOT}/scripts/run_modyco_open_sentence_whisper_seamless_080.sh"
...
exec timeout 13h bash "$TARGET_SCRIPT"
