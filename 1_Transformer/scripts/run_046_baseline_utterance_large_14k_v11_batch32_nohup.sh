#!/usr/bin/env bash
# Run 046 — baseline ST utterance L-14k v11 batch effectif 32 (piste B).
#
# Durée estimée : ~8–10 h GPU.
#
# Lancement nohup (Modyco) :
#   nohup bash 1_Transformer/scripts/run_046_baseline_utterance_large_14k_v11_batch32_nohup.sh \
#     > logs/run_046_st_14k_v11_batch32_wrapper.log 2>&1 &
...
CFG="1_Transformer/configs/fr-en/base_utterance_large_14k_v11_batch32.yaml"
RUN="run_046_transformer_baseline_utterance_large_14k_v11_batch32"
