#!/usr/bin/env bash
# Run 027 — baseline ST utterance L-14k v6 long (PRD 120k + SpecAugment).
#
# Durée estimée : ~12–18 h GPU (Modyco).
#
# Lancement nohup (Modyco) :
#   nohup bash 1_Transformer/scripts/run_027_baseline_utterance_large_14k_v6_long_nohup.sh \
#     > logs/run_027_st_14k_v6_wrapper.log 2>&1 &
...
CFG="1_Transformer/configs/fr-en/base_utterance_large_14k_v6_long.yaml"
RUN="run_027_transformer_baseline_utterance_large_14k_v6_long"
...

{
  ...
  echo "=== $(date -Is) TRAIN ${RUN} (L-14k v6 long: 120k upd, SpecAugment) ==="
