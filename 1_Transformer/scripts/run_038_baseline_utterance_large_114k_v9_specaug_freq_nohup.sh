#!/usr/bin/env bash
# Run 038 — baseline ST utterance L-114k v9 SpecAugment temporel + fréquentiel (OVH).
#
# Durée estimée : ~9–12 h GPU.
#
# Lancement nohup (OVH) :
#   nohup bash 1_Transformer/scripts/run_038_baseline_utterance_large_114k_v9_specaug_freq_nohup.sh \
#     > logs/run_038_st_114k_v9_specaug_freq_wrapper.log 2>&1 &
...
CFG="1_Transformer/configs/fr-en/base_utterance_large_114k_v9_specaug_freq.yaml"
RUN="run_038_transformer_baseline_utterance_large_114k_v9_specaug_freq"
...
"
  ...
  echo "=== $(date -Is) TRAIN ${RUN} (L-114k v9: SpecAugment time + freq) ==="
