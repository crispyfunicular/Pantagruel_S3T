#!/usr/bin/env bash
# Run 033 — baseline ST utterance L-114k v7 (SPM 5k + SpecAugment, piste 3 Table 8).
#
# Recette run_028 v5 + vocab SentencePiece 5000.
# Durée estimée : ~10–12 h GPU (OVH).
#
# Lancement nohup (OVH) :
#   cd ~/S3T && source .venv/bin/activate
#   mkdir -p logs
#   nohup bash 1_Transformer/scripts/run_033_baseline_utterance_large_114k_v7_spm5k_nohup.sh \
#     > logs/run_033_st_114k_v7_wrapper.log 2>&1 &
#   tail -f logs/run_033_transformer_baseline_utterance_large_114k_v7_spm5k_spm_train_eval.log
...
CFG="1_Transformer/configs/fr-en/base_utterance_large_114k_v7_spm5k.yaml"
RUN="run_033_transformer_baseline_utterance_large_114k_v7_spm5k"
...
"
  ...
  echo "=== $(date -Is) TRAIN ${RUN} (L-114k v7: SPM 5k + SpecAugment) ==="
