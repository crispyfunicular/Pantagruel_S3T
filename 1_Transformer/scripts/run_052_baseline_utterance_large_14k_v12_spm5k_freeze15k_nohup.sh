#!/usr/bin/env bash
# Run 052 — baseline ST utterance L-14k v12 (SPM 5k + gel encodeur 15k, piste E).
#
# Recette run_031 v7 + freeze_encoder_updates 15k.
# Durée estimée : ~8–12 h GPU (budget Modyco ≤ 13 h).
#
# Lancement nohup (Modyco) :
#   nohup bash 1_Transformer/scripts/run_052_baseline_utterance_large_14k_v12_spm5k_freeze15k_nohup.sh \
#     > logs/run_052_st_14k_v12_wrapper.log 2>&1 &
...
CFG="1_Transformer/configs/fr-en/base_utterance_large_14k_v12_spm5k_freeze15k.yaml"
RUN="run_052_transformer_baseline_utterance_large_14k_v12_spm5k_freeze15k"
...
"
  ...
  echo "=== $(date -Is) TRAIN ${RUN} (L-14k v12: SPM 5k + gel 15k + SpecAugment) ==="
