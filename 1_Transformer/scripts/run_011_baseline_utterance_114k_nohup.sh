#!/usr/bin/env bash
# Baseline ST Table 8 — utterance, encodeur Pantagruel-L-114k (speech-large-114K).
#
# Prérequis : manifests utterance + SPM fr-en_1000.
...
#     > logs/run_011_transformer_utterance_114k_wrapper.log 2>&1 &
...
CFG="1_Transformer/configs/fr-en/base_utterance_large_114k.yaml"
RUN="run_011_transformer_baseline_utterance_large_114k"
...
"
  ...
  echo "=== $(date -Is) TRAIN ${RUN} (Pantagruel-L-114k) ==="
