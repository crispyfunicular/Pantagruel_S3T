...
[^37]: `run_037_transformer_baseline_utterance_large_14k_v9_specaug_strong` — **24,55** test (machine GPU locale, 17 juin — SpecAugment fort, sous run_026)
[^38]: `run_038_transformer_baseline_utterance_large_114k_v9_specaug_freq` — **24,78** test (serveur cloud GPU, 18 juin)
[^42]: `run_042_transformer_baseline_utterance_large_114k_v10_warmup10k` — **24,11** test (serveur cloud GPU, 19 juin)
[^46]: `run_046_transformer_baseline_utterance_large_14k_v11_batch32` — **2,76** test (collapse, machine GPU locale)
[^49]: `run_049_transformer_baseline_utterance_large_14k_v5_seed2` — **23,84** test (machine GPU locale, seed 2)
[^47]: `run_047_speechllm_b1_utterance_large_14k_layer9` — **14,00 / 15,10** test/dev (couche 9, machine GPU locale, 22 juin — sous run_012 **15,03**)
[^48]: `run_048_speechllm_b1_utterance_large_14k_layer6` — **12,41 / 13,69** test/dev (couche 6, machine GPU locale, 22 juin — piste J)
[^50]: `run_050_speechllm_b1_utterance_large_14k_seed2` — **14,01 / 14,56** test/dev (seed 2, machine GPU locale, 22–23 juin)
[^51]: `run_051_speechllm_b1_utterance_large_14k_encoder_control` — **13,58 / 14,57** test/dev (contrôle `encoder_layer: -1`, machine GPU locale, 27 juin — piste J clos)
