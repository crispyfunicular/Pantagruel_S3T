...
[^48]: `run_048_speechllm_b1_utterance_large_14k_layer6` — **12,41 / 13,69** test/dev (couche 6, Modyco, 22 juin — piste J)
[^50]: `run_050_speechllm_b1_utterance_large_14k_seed2` — **14,01 / 14,56** test/dev (seed 2, Modyco, 22–23 juin)
[^51]: `run_051_speechllm_b1_utterance_large_14k_encoder_control` — **13,58 / 14,57** test/dev (contrôle `encoder_layer: -1`, Modyco, 27 juin — piste J clos)
[^52]: `run_052_speechllm_b2bis_utterance_large_14k_llama32_3b` — **16,31 / 18,28** test/dev (Llama-3.2-3B, Modyco, 30 juin — **meilleur speechLLM**)
[^54]: `run_054_speechllm_b2bis_utterance_large_14k_mistral_7b` — **14,22 / 14,76** test/dev (Mistral-7B 4-bit, Modyco, 2 juil. — sous Phi-2 et Llama)
