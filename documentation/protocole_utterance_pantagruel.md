...
| speechLLM **L-114k v5** (SpecAugment) | `run_044_speechllm_b1_utterance_large_114k_v5_specaug` | `2_speechLLM/configs/fr-en/b1_utterance_large_114k_v5_specaug.yaml` | **20k updates** | **échec** (Modyco, 17 juin — HF `speech-large-114K` gated ; relancer sur OVH) |
